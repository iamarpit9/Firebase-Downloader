package com.example.firebasefiledownloader.util;
...
public class encryption {
    ...
    private final static int READ_WRITE_BLOCK_SIZE = 1024;
    ...
    public static void encryptToFile(String keyStr, String specStr, InputStream in, OutputStream out)
            throws InvalidAlgorithmParameterException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, IOException {
        ...
        try {
            ...
            int count = 0;
            byte[] buffer = new byte[READ_WRITE_BLOCK_SIZE];
